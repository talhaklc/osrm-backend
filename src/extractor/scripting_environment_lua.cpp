...
void Sol2ScriptingEnvironment::InitContext(LuaScriptingContext &context)
{
    ...
    context.state.new_enum("road_priority_class",
                           ...
                           "motorway_link",
                           extractor::guidance::RoadPriorityClass::MOTORWAY_LINK,
                           "trunk",
                           extractor::guidance::RoadPriorityClass::TRUNK,
                           "trunk_link",
                           extractor::guidance::RoadPriorityClass::TRUNK_LINK,
                           "primary",
                           extractor::guidance::RoadPriorityClass::PRIMARY,
                           "primary_link",
                           extractor::guidance::RoadPriorityClass::PRIMARY_LINK,
                           "secondary",
                           extractor::guidance::RoadPriorityClass::SECONDARY,
                           "secondary_link",
                           extractor::guidance::RoadPriorityClass::SECONDARY_LINK,
                           "tertiary",
                           extractor::guidance::RoadPriorityClass::TERTIARY,
                           "tertiary_link",
                           extractor::guidance::RoadPriorityClass::TERTIARY_LINK,
                           "main_residential",
                           extractor::guidance::RoadPriorityClass::MAIN_RESIDENTIAL,
                           "side_residential",
                           extractor::guidance::RoadPriorityClass::SIDE_RESIDENTIAL,
                           "alley",
                           extractor::guidance::RoadPriorityClass::ALLEY,
                           "parking",
